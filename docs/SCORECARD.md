...
**Executive Summary:** Reconciled **57 bank transactions** against Razorpay settlements in **0.0777s** (733.59 rows/sec) with **89.47% automated match rate**, zero dropped records, and complete diagnostic accountability.
...
| **Execution Time** | `0.0777` | Seconds (Measured Wall-Clock) |
| **Processing Throughput** | `733.59` | Rows / Second |
...
| **Tier 0** | Date Window (±3d) + Amount Fallback | `1` | `1.75%` | `SUGGESTED` match (Missing UTR fallback) |
...
|---|---|---|---|---|---|
| `534cf734...` | 2026-08-25 | ₹ 18,450.00 | `UNRESOLVED` | NEFT/ICIC009283921099/UNKNOWN TRANSFER | No matching Razorpay settlement found for bank row (₹ 18,450.00, ref: ICIC009283921099). |
| `7aa6396b...` | 2026-08-24 | ₹ 6,200.00 | `UNRESOLVED` | RTGS/SBI002938491899/CLIENT INWARD | No matching Razorpay settlement found for bank row (₹ 6,200.00, ref: SBI002938491899). |

*Report generated on 2026-08-31 12:37:12 UTC by `scripts/generate_scorecard_report.py`.*
